...
async function handleRequest(request: Request, env: Env) {
  ...
  // Generate an authorization URL to login into Dribbble, and a set of
  ...
  // Once the user has been authorized via login page, Dribbble will
  ...
  if (request.method === "GET" && requestUrl.pathname.startsWith("/redirect")) {
    ...
    // Retrieve the access token and expiry
